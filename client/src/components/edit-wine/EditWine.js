...
class EditWine extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.wine.wine) {
      const wine = nextProps.wine.wine;
  ...
  onSubmit(e) {
    ...
    this.props.editWine(wineId, updatedWine);
  }
...
export default connect(mapStateToProps, { getWine, editWine })(withRouter(EditWine));